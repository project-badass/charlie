...
if (process.argv.length < 3) {
	console.log("Usage: node intern /path/to/object/schema");
	console.log("  * Please see https://github.com/tupakapoor/intern");
...
try {
	...
	console.log("  * Visit https://github.com/tupakapoor/intern");
	console.log("  * for information about the object schema file.");
	process.exit(1);
}
